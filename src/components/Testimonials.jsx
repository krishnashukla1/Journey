...
const Testimonials = () => {
  ...
  return (
    // <div className="grid-cols-2 p-6 mb-8 bg-white rounded-lg shadow-md">
    <div className="grid items-center grid-cols-1 gap-8">
      {/* <h2 className="mb-6 text-2xl italic font-sm">Helping Travellers to experience the most exciting trip at Andaman Islands.</h2>
      ...
      <div className="grid grid-cols-2 gap-6 mb-8 md:grid-cols-4">
        ...
        <div className="text-center">
          <h3 className="text-5xl font-bold">53k+</h3>
      ...
      <div className="p-6 mb-8 bg-white rounded-lg shadow-md">
        <div className="grid items-center grid-cols-1 gap-8 md:grid-cols-2">
          {/* LEFT CONTENT */}
          {/* <div>
            <h2 className="mb-10 text-4xl italic">
              Helping Travellers to experience the most exciting trip at Andaman
              Islands.
            </h2>
...
<div>
  <h2 className="mb-10 text-xl italic md:text-4xl">
    Helping Travellers to experience the most exciting trip at Andaman
    Islands.
  </h2>
  ...
  <div className="grid grid-cols-2 gap-6 mb-10 md:grid-cols-4">
    <div className="text-center">
      <h3 className="text-2xl font-bold md:text-5xl">19+</h3>
      <p className="text-xs font-bold md:text-base">PRO GUIDES</p>
    </div>
    <div className="text-center">
      <h3 className="text-2xl font-bold md:text-5xl">15k+</h3>
      <p className="text-xs font-bold md:text-base">PACKAGES SOLD</p>
    </div>
    <div className="text-center">
      <h3 className="text-2xl font-bold md:text-5xl">53k+</h3>
      <p className="text-xs font-bold md:text-base">TRAVELLERS SERVED</p>
    </div>
    <div className="text-center">
      <h3 className="text-2xl font-bold md:text-5xl">8+</h3>
      <p className="text-xs font-bold md:text-base">YEAR SERVING</p>
    </div>
  </div>
</div>
        ...
        <div className="flex mt-2">
          ...
          <div className="max-w-3xl p-6 mx-auto bg-gray-100 rounded-lg shadow-md">
            ...
            <div className="flex items-start gap-4">
              ...
              />
              <div>
                <p className="mb-4 text-2xl italic">{testimonial.text}</p>
